...
//     try {
//       final next = await _joinSvc.checkJoin(); // "OPEN_DEPOSIT" | "DO_PROFILE" | "OK"
//
//       if (next == "OPEN_DEPOSIT") {
//         Navigator.push(context, MaterialPageRoute(builder: (_) => const DepositAccountPage()));
//         return;
//       }
//       if (next == "DO_PROFILE") {
//         Navigator.push(context, MaterialPageRoute(builder: (_) => const InvestProfilePage()));
//         return;
//       }
//       // OK → 가입 화면으로 (fundId만 전달)
//       Navigator.push(
//         context,
